...
const FRAMEPACK: ModelConfig = {
  ...
  tier: "BUDGET",
  creditCost: 600,
  creditCostTable: { "10": 600, "15": 900, "20": 1200, "30": 1800 },
  supportedModes: ["I2V"],
  maxDuration: 30,
  maxResolution: "720p",
  supportsAudio: false,
...
const SORA_2: ModelConfig = {
  ...
  tier: "STANDARD",
  creditCost: 1300,
  creditCostTable: { "4": 650, "8": 1300, "12": 2000 },
  supportedModes: ["T2V", "I2V"],
  maxDuration: 12,
  maxResolution: "720p",
  supportsAudio: false,
...
const SORA_2_PRO: ModelConfig = {
  ...
  creditCost: 3900,
  creditCostTable: {
    "4_720p": 2000, "8_720p": 3900, "12_720p": 5800,
    "4_1080p": 2000, "8_1080p": 3900, "12_1080p": 5800,
  },
  supportedModes: ["T2V", "I2V"],
  maxDuration: 12,
  maxResolution: "1080p",
...
const VEO_31: ModelConfig = {
  ...
  creditCost: 2000,
  creditCostTable: {
    "4_720p": 1000, "6_720p": 1500, "8_720p": 2000,
    "4_1080p": 1000, "6_1080p": 1500, "8_1080p": 2000,
  },
  audioCreditAddon: { "4": 1000, "6": 1500, "8": 2000 },
  supportedModes: ["T2V", "I2V"],
  maxDuration: 8,
  maxResolution: "1080p",
  supportsAudio: true,
