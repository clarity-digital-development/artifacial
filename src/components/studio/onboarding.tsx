  ...
  return (
    <div className="flex flex-1 flex-col items-center justify-center py-16">
      ...
      <div className="mt-10 flex w-full max-w-xs flex-col gap-3 sm:w-auto sm:flex-row sm:gap-4">
        <Link
          href="/generate"
          className="inline-flex items-center justify-center gap-2 rounded-[var(--radius-md)] bg-[var(--accent-amber)] px-6 py-3 text-[var(--text-base)] font-semibold text-[var(--bg-deep)] shadow-[0_0_32px_rgba(232,166,52,0.15)] transition-all duration-300 hover:bg-[var(--accent-amber-dim)] hover:shadow-[0_0_48px_rgba(232,166,52,0.25)]"
        >
        ...
        <Link
          href="/characters/new"
          className="inline-flex items-center justify-center gap-2 rounded-[var(--radius-md)] border border-[var(--border-default)] px-6 py-3 text-[var(--text-base)] font-medium text-[var(--text-primary)] transition-all duration-300 hover:bg-[var(--bg-elevated)] hover:border-[var(--text-muted)]"
        >
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
