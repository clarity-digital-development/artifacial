    ...
    <div>
      <div className="mb-10 flex items-center justify-between">
        ...
        <div className="flex flex-col gap-1.5 sm:flex-row sm:items-center sm:gap-2">
          ...
          <Link
            href="/characters/new"
            className="inline-flex items-center justify-center gap-1.5 rounded-[var(--radius-md)] bg-[var(--accent-amber)] px-3 py-1.5 text-xs font-semibold text-[var(--bg-deep)] shadow-[0_0_24px_rgba(232,166,52,0.12)] transition-all duration-200 hover:bg-[var(--accent-amber-dim)] sm:px-5 sm:py-2.5 sm:text-sm"
          >
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
