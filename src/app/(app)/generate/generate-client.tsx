...
const MODELS: ClientModel[] = [
  ...
  // ── Motion Control ──
  { id: "kling-26-motion-std", name: "Kling 2.6 Motion (Standard)", provider: "PIAPI", tier: "STANDARD", creditCost: 850, creditCostTable: { "5": 850, "10": 1700 }, supportedModes: ["MOTION_TRANSFER"], maxDuration: 10, maxResolution: "720p", supportsAudio: false, contentMode: "SFW", description: "Copy motion from reference video. 720p output.", durations: [5, 10], aspectRatios: [], resolutions: [], supportsEndFrame: false },
  { id: "kling-26-motion-pro", name: "Kling 2.6 Motion (Pro)", provider: "PIAPI", tier: "ULTRA", creditCost: 1400, creditCostTable: { "5": 1400, "10": 2700 }, supportedModes: ["MOTION_TRANSFER"], maxDuration: 10, maxResolution: "1080p", supportsAudio: false, contentMode: "SFW", description: "Copy motion from reference video. 1080p output.", durations: [5, 10], aspectRatios: [], resolutions: [], supportsEndFrame: false },
  { id: "kling-30-motion-pro", name: "Kling 3.0 Motion", provider: "PIAPI", tier: "ULTRA", creditCost: 2100, creditCostTable: { "5": 2100, "10": 4100, "15": 6200 }, supportedModes: ["MOTION_TRANSFER"], maxDuration: 15, maxResolution: "1080p", supportsAudio: false, contentMode: "SFW", description: "Kling 3.0 motion control. 1080p, up to 15 seconds.", durations: [5, 10, 15], aspectRatios: [], resolutions: [], supportsEndFrame: false, badge: "New" },
  // ── NSFW Budget ──
        ...
        {isMotionMode && needsImage && needsVideo && (
          <div className="mb-4">
            ...
            <p className="mt-2 text-[10px] text-[var(--text-muted)]">
              Output aspect ratio follows your reference video. Quality is set by the model you select above (Standard = 720p, Pro / Kling 3.0 = 1080p).
            </p>
