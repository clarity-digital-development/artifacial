...
const MODELS: ClientModel[] = [
  ...
  // Seedance 2: $0.12/s → 2400 cr/5s
  { id: "seedance-2", name: "Seedance 2", provider: "PIAPI", tier: "STANDARD", creditCost: 2400, creditCostTable: { "5": 2400 }, supportedModes: ["T2V", "I2V"], maxDuration: 5, maxResolution: "1080p", supportsAudio: false, contentMode: "SFW", description: "ByteDance's latest.", durations: [5], aspectRatios: ["16:9", "9:16", "4:3", "3:4"], resolutions: [], supportsEndFrame: false },
