...
const MODELS: ClientModel[] = [
  ...
  { id: "wan21-pro-nsfw-i2v", name: "Wan 2.1 Pro NSFW", provider: "VENICE", tier: "BUDGET", creditCost: 1100, creditCostTable: { "6": 1100 }, supportedModes: ["I2V"], maxDuration: 6, maxResolution: "720p", supportsAudio: false, contentMode: "NSFW", description: "Reliable unrestricted image-to-video. 6 seconds.", durations: [6], aspectRatios: ["16:9", "9:16", "1:1"], resolutions: [], supportsEndFrame: false },
  { id: "nsfw-ltx-2.0", name: "LTX 2.0 NSFW", provider: "VENICE", tier: "BUDGET", creditCost: 850, creditCostTable: { "5": 850 }, supportedModes: ["T2V"], maxDuration: 5, maxResolution: "720p", supportsAudio: false, contentMode: "NSFW", description: "Fast NSFW video generation.", durations: [5], aspectRatios: ["16:9", "9:16", "1:1"], resolutions: [], supportsEndFrame: false },
  // ── NSFW Standard ──
  { id: "wan25-preview-nsfw-t2v", name: "Wan 2.5 NSFW", provider: "VENICE", tier: "STANDARD", creditCost: 1800, creditCostTable: { "5": 1800, "10": 3500 }, supportedModes: ["T2V"], maxDuration: 10, maxResolution: "720p", supportsAudio: true, contentMode: "NSFW", description: "Latest Wan with audio support. Unrestricted T2V.", durations: [5, 10], aspectRatios: ["16:9", "9:16", "1:1"], resolutions: [], supportsEndFrame: false, badge: "New" },
  { id: "wan25-preview-nsfw-i2v", name: "Wan 2.5 NSFW", provider: "VENICE", tier: "STANDARD", creditCost: 1800, creditCostTable: { "5": 1800, "10": 3500 }, supportedModes: ["I2V"], maxDuration: 10, maxResolution: "720p", supportsAudio: true, contentMode: "NSFW", description: "Latest Wan with audio support. Unrestricted I2V.", durations: [5, 10], aspectRatios: ["16:9", "9:16", "1:1"], resolutions: [], supportsEndFrame: false, badge: "New" },
  ...
  // ── NSFW Ultra ──
  { id: "nsfw-longcat", name: "Longcat NSFW", provider: "VENICE", tier: "ULTRA", creditCost: 2100, creditCostTable: { "5": 2100 }, supportedModes: ["T2V"], maxDuration: 5, maxResolution: "1080p", supportsAudio: false, contentMode: "NSFW", description: "Premium NSFW video. Highest quality.", durations: [5], aspectRatios: ["16:9", "9:16", "1:1"], resolutions: [], supportsEndFrame: false },
];
