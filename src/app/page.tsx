...
const SHOWCASE_SECTIONS = [
  ...
  },
  {
    ...
    cards: [
      { title: "Movie Scene", gradient: "from-emerald-900/20 to-green-900/10" },
      { title: "Music Video", gradient: "from-pink-900/20 to-rose-900/10" },
      { title: "Historical Reenactment", gradient: "from-amber-900/20 to-yellow-900/10" },
      { title: "Sport Highlight", gradient: "from-cyan-900/20 to-teal-900/10" },
    ],
  },
  {
    ...
    cards: [
      { title: "Dance Routine", gradient: "from-fuchsia-900/20 to-pink-900/10" },
      { title: "Martial Arts", gradient: "from-red-900/20 to-orange-900/10" },
      { title: "Yoga Flow", gradient: "from-teal-900/20 to-emerald-900/10" },
      { title: "Performance Art", gradient: "from-indigo-900/20 to-violet-900/10" },
    ],
  },
  {
    label: "Talking Head",
    ...
    cards: [
      { title: "Podcast Avatar", gradient: "from-blue-900/20 to-indigo-900/10" },
      { title: "Narrator", gradient: "from-amber-900/20 to-orange-900/10" },
      { title: "Tutorial Host", gradient: "from-green-900/20 to-emerald-900/10" },
      { title: "Character Dialogue", gradient: "from-purple-900/20 to-violet-900/10" },
    ],
  },
  {
      ...
      <section id="showcase" className="relative z-10 py-16">
        {SHOWCASE_SECTIONS.map((section, sectionIdx) => (
          <div key={section.label} className="mb-16 last:mb-0">
            ...
            <div className="flex gap-4 overflow-x-auto px-8 pb-4 lg:px-16 scrollbar-hide">
              {section.cards.map((card, cardIdx) => (
                <div
                  key={card.title}
                  className="group relative flex-shrink-0 w-[280px] aspect-[16/10] rounded-[var(--radius-lg)] border border-[var(--border-subtle)] bg-[var(--bg-surface)] overflow-hidden transition-all duration-300 hover:border-[var(--accent-amber)]/30 hover:shadow-[0_0_24px_rgba(232,166,52,0.08)] hover:scale-[1.02]"
                  style={{
